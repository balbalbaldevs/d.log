...
@RestController
@Api(value = "swag-rest-controller", description = "FoodContoller")
public class SampleController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/sample/foods", method = RequestMethod.GET)
	@ResponseBody
	public List<?> getFoodInfo(@RequestParam String paraStr) throws Exception {
		...
		urlBuilder.append("&" + URLEncoder.encode("bgn_year", "UTF-8") + "=" + URLEncoder.encode("2017", "UTF-8")); // 자료
																													// 구축년도

		urlBuilder.append("&" + URLEncoder.encode("desc_kor", "UTF-8") + "=" + URLEncoder.encode(paraStr, "UTF-8")); // 식품
																														// 이름
